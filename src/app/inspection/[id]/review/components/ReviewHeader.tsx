...
export default function ReviewHeader({ inspection }: ReviewHeaderProps) {
  ...
  return (
    <div className="avoid-page-break border-b-2 md:border-b-4 border-red-600 pb-6 md:pb-8 mb-6 md:mb-12 flex flex-col md:flex-row justify-between items-start gap-4 md:gap-0 font-sans">
      <div className="space-y-4 w-full md:w-auto">
        <div className="flex flex-col gap-2">
          ...
          {inspection.parentTitle && (
            <p className="text-sm md:text-lg font-black uppercase tracking-widest text-red-600 -mt-1">{inspection.parentTitle}</p>
          )}
          <img 
            src="/blacklogo.jpeg" 
            alt="Logo" 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-4 pt-4">
          ...
          <div>
            ...
            <p className="text-sm font-bold text-zinc-900 break-words">{inspection.teilnehmer || 'Robin Furrer'}</p>
          </div>
        </div>
      </div>
