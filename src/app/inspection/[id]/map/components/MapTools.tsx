    ...
    <div className="fixed right-2 md:right-8 top-[45%] -translate-y-1/2 flex flex-col gap-2 md:gap-4 z-60">
      {tools.map((tool, i) => (
        <motion.button
          ...
          className="w-10 h-10 md:w-16 md:h-16 bg-zinc-900/95 sm:bg-zinc-900/90 sm:backdrop-blur-xl rounded-lg md:rounded-xl border border-white/10 flex items-center justify-center text-white/50 hover:text-white hover:bg-red-600/20 transition-all cursor-pointer shadow-xl group active:bg-red-600/40"
          title={tool.label}
        >
